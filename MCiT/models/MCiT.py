...
class Embeddings(nn.Module):
    ...
    def __init__(self, config,channels = 3):
        ...
        self.cls_tokens = nn.Parameter(torch.zeros(1, 1 + self.num_lead, config.hidden_size)) # cls, seg 用
...
class te(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.max_position_embeddings = self.num_lead*self.patch_num_v*self.patch_num_h+(self.num_lead+1) # 誘導画像数*パッチ数 + seg + cls
